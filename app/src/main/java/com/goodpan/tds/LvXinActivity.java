...
public class LvXinActivity extends AppCompatActivity implements CountdownView.OnCountdownEndListener{
    ...
    //半圆
    com.goodpan.tds.view.CircleChart01View halfchart = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //圆形
        halfchart = (com.goodpan.tds.view.CircleChart01View)findViewById(R.id.halfcircle_view);
        halfchart.setPercentage(82);
